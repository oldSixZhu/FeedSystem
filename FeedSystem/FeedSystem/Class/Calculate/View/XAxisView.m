...
//        NSLog(@"%f",_currentLoc.x/self.pointGap);
        ...
        if(nowPoint >= 0 && nowPoint < [self.yValueArray count]) {
            ...
            if ([self isPureFloat:[num floatValue]]) {
                [[NSString stringWithFormat:@"%@:%.2fm", self.yName,[num floatValue]] drawAtPoint:CGPointMake(drawPoint.x, drawPoint.y+15) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12],NSForegroundColorAttributeName:[UIColor blackColor]}];
            }
            else {
                [[NSString stringWithFormat:@"%@:%.0fm",self.yName, [num floatValue]] drawAtPoint:CGPointMake(drawPoint.x, drawPoint.y+15)withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12],NSForegroundColorAttributeName:[UIColor blackColor]}];
            ...
            [self drawLine:context startPoint:CGPointMake(selectPoint.x, 0) endPoint:CGPointMake(selectPoint.x, self.frame.size.height- textSize.height - 5) lineColor:[UIColor blackColor] lineWidth:1];
